            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user-sites.store', ['site' => $site->slug]) }}">
                        ...
                        <div class="mb-3">
                            <label for="slug" class="form-label">사이트 주소 (슬러그) <span class="text-danger">*</span></label>
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       ...
                                       required
                                       pattern="[a-zA-Z0-9-]+"
                                       title="영문, 숫자, 하이픈(-)만 사용 가능합니다.">
                                <span class="input-group-text">.{{ config('app.master_domain', 'seoomweb.com') }}</span>
                            </div>
                            @error('slug')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">영문, 숫자, 하이픈(-)만 사용 가능합니다.</small>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 사이트 이름 입력 시 슬러그 자동 생성 (사용자가 입력하지 않은 경우에만)
