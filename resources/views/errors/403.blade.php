    ...
    <div class="row justify-content-center align-items-center" style="min-height: 60vh;">
        <div class="col-md-6 text-center">
            <div class="error-page">
                ...
                <h2 class="h4 mb-3">접근 권한이 없습니다</h2>
                <p class="text-muted mb-4">
                    이 페이지에 접근할 권한이 없습니다.<br>
                    관리자에게 문의하시거나 로그인 후 다시 시도해주세요.
                </p>
                <div class="d-flex gap-2 justify-content-center">
                    ...
                    @guest
                        @if($isMasterPath)
                            <a href="{{ route('master.login') }}" class="btn btn-primary">
                                <i class="bi bi-box-arrow-in-right me-1"></i>마스터 로그인
                            </a>
                        @elseif($siteSlug)
                            <a href="{{ route('login', ['site' => $siteSlug]) }}" class="btn btn-primary">
                    ...
                    @if($isMasterPath)
                        <a href="{{ route('master.login') }}" class="btn btn-outline-primary">
                            <i class="bi bi-house me-1"></i>마스터 콘솔
                        </a>
                    @elseif($siteSlug)
                        <a href="{{ route('home', ['site' => $siteSlug]) }}" class="btn btn-outline-primary">
