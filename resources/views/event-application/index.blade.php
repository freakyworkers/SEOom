                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="mb-2">
                                <small class="text-muted">
                                    완료 {{ $product->completed_count }}건 거절 {{ $product->rejected_count }}건
                                </small>
                            </div>
                            <a href="{{ route('event-application.show', ['site' => $site->slug, 'product' => $product->id]) }}" 
                               class="btn btn-primary w-100">
                                <i class="bi bi-check-circle me-1"></i>신청하기
                            </a>
                        </div>
                    </div>
                </div>
