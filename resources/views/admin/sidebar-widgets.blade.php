                                    ...
                                    <form id="addWidgetForm">
                                        ...
                                        <div class="mb-3" id="widget_block_slide_container" style="display: none;">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" 
                                                       class="form-control" 
                                                       id="sidebar_block_slide_hold_time" 
                                                       name="sidebar_block_slide_hold_time" 
                                                       value="3" 
                                                       min="0.5" 
                                                       max="60" 
                                                       step="0.1"
                ...
                <form id="editWidgetForm">
                    ...
                    <div class="mb-3" id="edit_widget_block_slide_container" style="display: none;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" 
                                   class="form-control" 
                                   id="edit_sidebar_block_slide_hold_time" 
                                   name="edit_sidebar_block_slide_hold_time" 
                                   value="3" 
                                   min="0.5" 
                                   max="60" 
                                   step="0.1"
                    ...
                    <div class="mb-3" id="edit_widget_image_container" style="display: none;">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input edit-sidebar-widget-image-text-overlay" 
                                       type="checkbox" 
                                       id="edit_widget_image_text_overlay" 
                                       name="image_text_overlay"
                                       onchange="toggleEditSidebarWidgetImageTextOverlay()">
                                <label class="form-check-label" for="edit_widget_image_text_overlay">
                                    이미지 위 텍스트 활성화
                                </label>
                            </div>
                        </div>
                        <div id="edit_widget_image_text_overlay_container" style="display: none;">
                            <div class="mb-3">
                                <label class="form-label">제목</label>
                                <input type="text" class="form-control edit-sidebar-widget-image-title" id="edit_widget_image_title" name="image_title" placeholder="제목을 입력하세요">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">제목 폰트 크기 (px)</label>
                                <input type="number" class="form-control edit-sidebar-widget-image-title-font-size" id="edit_widget_image_title_font_size" name="image_title_font_size" value="24" min="10" max="100">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">내용</label>
                                <textarea class="form-control edit-sidebar-widget-image-content" id="edit_widget_image_content" name="image_content" rows="3" placeholder="내용을 입력하세요"></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">내용 폰트 크기 (px)</label>
                                <input type="number" class="form-control edit-sidebar-widget-image-content-font-size" id="edit_widget_image_content_font_size" name="image_content_font_size" value="16" min="10" max="100">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">제목과 내용 사이 여백 (px)</label>
                                <input type="number" class="form-control edit-sidebar-widget-image-title-content-gap" id="edit_widget_image_title_content_gap" name="image_title_content_gap" value="10" min="0" max="100">
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control edit-sidebar-widget-image-text-padding-left" id="edit_widget_image_text_padding_left" name="image_text_padding_left" value="0" min="0" max="200">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small">우 (px)</label>
                                        <input type="number" class="form-control edit-sidebar-widget-image-text-padding-right" id="edit_widget_image_text_padding_right" name="image_text_padding_right" value="0" min="0" max="200">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small">상 (px)</label>
                                        <input type="number" class="form-control edit-sidebar-widget-image-text-padding-top" id="edit_widget_image_text_padding_top" name="image_text_padding_top" value="0" min="0" max="200">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small">하 (px)</label>
                                        <input type="number" class="form-control edit-sidebar-widget-image-text-padding-bottom" id="edit_widget_image_text_padding_bottom" name="image_text_padding_bottom" value="10" min="0" max="200">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="btn-group w-100" role="group">
                                    <input type="radio" class="btn-check edit-sidebar-widget-image-align-h" name="edit_widget_image_align_h" id="edit_widget_image_align_left" value="left" checked>
                                    <label class="btn btn-outline-primary" for="edit_widget_image_align_left"><i class="bi bi-text-left"></i> 좌측</label>
                                    <input type="radio" class="btn-check edit-sidebar-widget-image-align-h" name="edit_widget_image_align_h" id="edit_widget_image_align_center" value="center">
                                    <label class="btn btn-outline-primary" for="edit_widget_image_align_center"><i class="bi bi-text-center"></i> 중앙</label>
                                    <input type="radio" class="btn-check edit-sidebar-widget-image-align-h" name="edit_widget_image_align_h" id="edit_widget_image_align_right" value="right">
                                    <label class="btn btn-outline-primary" for="edit_widget_image_align_right"><i class="bi bi-text-right"></i> 우측</label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">수직 정렬</label>
                                <div class="btn-group w-100" role="group">
                                    <input type="radio" class="btn-check edit-sidebar-widget-image-align-v" name="edit_widget_image_align_v" id="edit_widget_image_align_top" value="top">
                                    <label class="btn btn-outline-primary" for="edit_widget_image_align_top"><i class="bi bi-align-top"></i> 상단</label>
                                    <input type="radio" class="btn-check edit-sidebar-widget-image-align-v" name="edit_widget_image_align_v" id="edit_widget_image_align_middle" value="middle" checked>
                                    <label class="btn btn-outline-primary" for="edit_widget_image_align_middle"><i class="bi bi-align-middle"></i> 중앙</label>
                                    <input type="radio" class="btn-check edit-sidebar-widget-image-align-v" name="edit_widget_image_align_v" id="edit_widget_image_align_bottom" value="bottom">
                                    <label class="btn btn-outline-primary" for="edit_widget_image_align_bottom"><i class="bi bi-align-bottom"></i> 하단</label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">텍스트 색상</label>
                                <input type="color" class="form-control form-control-color edit-sidebar-widget-image-text-color" id="edit_widget_image_text_color" name="image_text_color" value="#ffffff" title="텍스트 색상 선택">
                            </div>
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input edit-sidebar-widget-image-has-button" type="checkbox" id="edit_widget_image_has_button" name="image_has_button" onchange="toggleEditSidebarWidgetImageButton()">
                                    <label class="form-check-label" for="edit_widget_image_has_button">버튼 추가</label>
                                </div>
                            </div>
                            <div id="edit_widget_image_button_container" style="display: none;">
                                <div class="mb-3">
                                    <label class="form-label">버튼 텍스트</label>
                                    <input type="text" class="form-control edit-sidebar-widget-image-button-text" id="edit_widget_image_button_text" name="image_button_text" placeholder="자세히 보기">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 링크</label>
                                    <input type="url" class="form-control edit-sidebar-widget-image-button-link" id="edit_widget_image_button_link" name="image_button_link" placeholder="https://example.com">
                                </div>
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input edit-sidebar-widget-image-button-new-tab" type="checkbox" id="edit_widget_image_button_new_tab" name="image_button_new_tab">
                                        <label class="form-check-label" for="edit_widget_image_button_new_tab">새창에서 열기</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 색상</label>
                                    <input type="color" class="form-control form-control-color edit-sidebar-widget-image-button-color" id="edit_widget_image_button_color" name="image_button_color" value="#0d6efd" title="버튼 색상 선택">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 텍스트 색상</label>
                                    <input type="color" class="form-control form-control-color edit-sidebar-widget-image-button-text-color" id="edit_widget_image_button_text_color" name="image_button_text_color" value="#ffffff" title="버튼 텍스트 색상 선택">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 테두리 색상</label>
                                    <input type="color" class="form-control form-control-color edit-sidebar-widget-image-button-border-color" id="edit_widget_image_button_border_color" name="image_button_border_color" value="#0d6efd" title="버튼 테두리 색상 선택">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 배경 투명도 (%)</label>
                                    <input type="number" class="form-control edit-sidebar-widget-image-button-opacity" id="edit_widget_image_button_opacity" name="image_button_opacity" min="0" max="100" value="100">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 호버 배경 색상</label>
                                    <input type="color" class="form-control form-control-color edit-sidebar-widget-image-button-hover-bg-color" id="edit_widget_image_button_hover_bg_color" name="image_button_hover_bg_color" value="#0b5ed7" title="버튼 호버 배경 색상 선택">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 호버 텍스트 색상</label>
                                    <input type="color" class="form-control form-control-color edit-sidebar-widget-image-button-hover-text-color" id="edit_widget_image_button_hover_text_color" name="image_button_hover_text_color" value="#ffffff" title="버튼 호버 텍스트 색상 선택">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">버튼 호버 테두리 색상</label>
                                    <input type="color" class="form-control form-control-color edit-sidebar-widget-image-button-hover-border-color" id="edit_widget_image_button_hover_border_color" name="image_button_hover_border_color" value="#0a58ca" title="버튼 호버 테두리 색상 선택">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       checked
                                       onchange="handleEditImageSlideModeChange('single')">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       onchange="handleEditImageSlideModeChange('infinite')">
...
function handleEditImageSlideModeChange(clickedType) {
...
// 사이드바 위젯 이미지 위젯 텍스트 오버레이 토글 함수
function toggleEditSidebarWidgetImageTextOverlay() {
    const checkbox = document.getElementById('edit_widget_image_text_overlay');
    const container = document.getElementById('edit_widget_image_text_overlay_container');
    const linkContainer = document.querySelector('#edit_widget_image_container .mb-3:nth-of-type(2)');
    const newTabContainer = document.querySelector('#edit_widget_image_container .mb-3:nth-of-type(3)');
    const hasButtonCheckbox = document.getElementById('edit_widget_image_has_button');
...
// 사이드바 위젯 이미지 위젯 버튼 토글 함수
function toggleEditSidebarWidgetImageButton() {
    const checkbox = document.getElementById('edit_widget_image_has_button');
    const container = document.getElementById('edit_widget_image_button_container');
    const linkContainer = document.querySelector('#edit_widget_image_container .mb-3:nth-of-type(2)');
    const newTabContainer = document.querySelector('#edit_widget_image_container .mb-3:nth-of-type(3)');
    ...
    if (checkbox && container) {
        ...
        if (checkbox.checked) {
            ...
            const textOverlayCheckbox = document.getElementById('edit_widget_image_text_overlay');
...
function addWidget() {
    ...
    if (widgetType === 'popular_posts' || widgetType === 'recent_posts' || widgetType === 'weekly_popular_posts' || widgetType === 'monthly_popular_posts') {
        ...
        // 슬라이드 유지 시간
        const slideHoldTime = parseFloat(document.getElementById('sidebar_block_slide_hold_time')?.value) || 3;
            ...
            .then(data => {
                if (data.success && data.widget) {
                    ...
                    if (widgetType === 'popular_posts' || widgetType === 'recent_posts' || widgetType === 'weekly_popular_posts' || widgetType === 'monthly_popular_posts') {
                        ...
                        const holdTimeInput = document.getElementById('edit_sidebar_block_slide_hold_time');
...
function saveWidgetSettings() {
    ...
    if (widgetType === 'popular_posts' || widgetType === 'recent_posts' || widgetType === 'weekly_popular_posts' || widgetType === 'monthly_popular_posts') {
        ...
        const backgroundType = document.getElementById('edit_widget_block_background_type').value || 'color';
                        ...
                        // 슬라이드 유지 시간
                        const slideHoldTime = parseFloat(document.getElementById('edit_sidebar_block_slide_hold_time')?.value) || 3;
                        settings.slide_hold_time = slideHoldTime;
