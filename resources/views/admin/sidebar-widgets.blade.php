                        ...
                        <div id="edit_widget_image_text_overlay_container" style="display: none;">
                            ...
                            <div id="edit_widget_image_button_container" style="display: none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="range" class="form-range edit-sidebar-widget-image-button-opacity" id="edit_widget_image_button_opacity" name="image_button_opacity" min="0" max="100" value="100" oninput="document.getElementById('edit_widget_image_button_opacity_value').textContent = this.value + '%'">
                                    <div class="d-flex justify-content-between">
                                        <small>0%</small>
                                        <small id="edit_widget_image_button_opacity_value">100%</small>
                                        <small>100%</small>
                                    </div>
                                </div>
                                <div class="mb-3">
