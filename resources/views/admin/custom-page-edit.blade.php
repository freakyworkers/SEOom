                            ...
                            <div class="mt-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control" id="edit_custom_page_widget_block_image_padding_left" value="0" min="0" max="200">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small">우 (px)</label>
                                        <input type="number" class="form-control" id="edit_custom_page_widget_block_image_padding_right" value="0" min="0" max="200">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small">상 (px)</label>
                                        <input type="number" class="form-control" id="edit_custom_page_widget_block_image_padding_top" value="0" min="0" max="200">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small">하 (px)</label>
                                        <input type="number" class="form-control" id="edit_custom_page_widget_block_image_padding_bottom" value="0" min="0" max="200">
                                    </div>
                                </div>
                            </div>
                        </div>
