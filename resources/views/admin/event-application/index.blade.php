...
@section('title', '신청형 이벤트 관리')
@section('page-title', '신청형 이벤트 관리')
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.event-application.update-settings', ['site' => $site->slug]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <!-- Form Fields -->
                    <div class="mb-3">
                        <label class="form-label">신청 폼</label>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted small mb-2">신청 버튼을 누르기 위한 조건입니다.</p>
                    ...
                    <div class="mb-3">
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-1">체크 시 상품 리스트가 랜덤하게 표시됩니다.</small>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="products_per_page" name="products_per_page" 
                                       ...
                                       min="1" required>
                                <small class="text-muted">한 페이지에 표시할 상품의 개수를 설정합니다.</small>
                            </div>
                            <div class="col-md-4">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="bi bi-box me-2"></i>상품</h5>
                            ...
                            @forelse($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.event-application.submissions', ['site' => $site->slug, 'product' => $product->id]) }}" 
                                           class="btn btn-sm btn-outline-info">
                                            <i class="bi bi-list"></i> 신청목록
                                        </a>
                                        <form action="{{ route('admin.event-application.destroy-product', ['site' => $site->slug, 'product' => $product->id]) }}" 
                        ...
                        <div class="card border mb-2">
                            <div class="card-body p-3">
                                ...
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-3">
                                        <div class="text-center p-2 bg-light rounded">
                                            <div class="small text-muted mb-1" style="font-size: 0.7rem;">거절</div>
...
<div class="modal fade" id="addProductModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.event-application.store-product', ['site' => $site->slug]) }}" 
...
<div class="modal fade" id="editProductModal{{ $product->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.event-application.update-product', ['site' => $site->slug, 'product' => $product->id]) }}" 
                  method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-header">
