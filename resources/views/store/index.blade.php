    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="mb-5">
                    ...
                    <div class="row g-4">
                        @foreach($paidPlans as $plan)
                            <div class="col-md-4">
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mt-auto">
                                            <div class="d-grid gap-2">
                                                <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#paidPlanModal{{ $plan->id }}">
                                                    자세히 보기
                                                </button>
                            ...
                            {{-- 플랜 상세 모달 --}}
                            <div class="modal fade" id="paidPlanModal{{ $plan->id }}" tabindex="-1">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">{{ $plan->name }}</h5>
            ...
            @if($serverPlans->isNotEmpty())
                <div class="mb-5">
                    <h4 class="mb-2">
                        <i class="bi bi-server me-2 text-info"></i>서버 용량
                    </h4>
                    <p class="text-muted mb-4">추가 스토리지와 트래픽을 구매하여 사이트에 적용할 수 있습니다.</p>
                    <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mt-auto">
                                            <div class="d-grid gap-2">
                                                <button type="button" class="btn btn-outline-info btn-sm" data-bs-toggle="modal" data-bs-target="#serverPlanModal{{ $plan->id }}">
                                                    자세히 보기
                                                </button>
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-info btn-sm w-100 text-white" data-bs-toggle="modal" data-bs-target="#serverPlanModal{{ $plan->id }}">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            @if($userSites->isNotEmpty())
                                                <form method="POST" action="{{ route('payment.process-subscription', ['plan' => $plan->slug]) }}" class="d-inline" id="serverPlanForm{{ $plan->id }}">
                                                    ...
                                                    <button type="submit" class="btn btn-info text-white" id="serverPlanSubmit{{ $plan->id }}" disabled>
                                                        <i class="bi bi-check-circle me-1"></i>구독하기
                                                    </button>
                                                </form>
                                            @endif
